...
<body>
	...
	<div class="col-md-10">
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Makanan</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span> Tambah Makanan</button>
<br/>
<br/>
...
<table class="table table-hover">
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				<a href="det-makanan.php?id=<?php echo $b['id']; ?>" class="btn btn-info">Detail</a>
				<a href="edit-makanan.php?id=<?php echo $b['id']; ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ?')){ location.href='hapus-makanan.php?id=<?php echo $b['id']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="tambah-makanan.php" method="post">
