...
<body>
	...
	<div class="col-md-10">
    <h3><span class="glyphicon glyphicon-briefcase"></span>  Detail Minuman</h3>
<a class="btn" href="minuman.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>

<?php
$id_brg=mysql_real_escape_string($_GET['id']);


$det=mysql_query("select * from minuman where id='$id_brg'")or die(mysql_error());
