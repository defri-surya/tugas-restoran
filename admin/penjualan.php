...
<body>
    ...
    <div class="col-md-10">
    <h3><span class="glyphicon glyphicon-briefcase"></span> Transaksi Pembelian Makanan</h3>
    <a class="btn" href="home.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php  
                            include 'conect.php';
                            $query = "SELECT nama FROM makanan";
        ...
        <table class="table table-hover">
            ...
            if (@$_POST["nama"]!=''){
                ...
                @$nama = $_POST['nama'];
                $tampil = mysql_fetch_array(mysql_query("select nama, harga from makanan where nama = '$nama'"));
                @$nama = $tampil["nama"];
                @$harga = $tampil["harga"];
                @$stok = trim($_POST["jumlah"]);
                @$sub=$harga*$stok;
                $tampilid=mysql_fetch_array(mysql_query("select id from makanan where nama='$nama'"));
                @$id=$tampilid["id"];
